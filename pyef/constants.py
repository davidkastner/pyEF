...
This module contains all physical constants, unit conversions, and atomic
property dictionaries used throughout the pyEF package. Centralizing these
values ensures consistency and maintainability.
